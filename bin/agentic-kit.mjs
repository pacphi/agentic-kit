...
Usage (ak = alias of agentic-kit):
  ...
  ak hooks           doctor, plan, heal, or undo hook configuration [doctor|heal|undo]
...
async function main() {
  ...
  if (!values.json && !values['dry-run'] && !['sync', 'usage', 'models', 'setup', 'host', 'audit', 'hooks', 'ruflo-mcp', 'aqe-provider'].includes(cmd)) {
    try {
