...
- **Update note:** Agentic-QE 3.13.12 satisfied the provider-registration request in
  ...
  closed-enum ceiling below without weakening the permanent ban on manifest self-claims.
