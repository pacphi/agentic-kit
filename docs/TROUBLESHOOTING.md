...
| Models shows `unknown` instead of yes/no | No accepted source established that independent fact | Treat unknown as unknown. Refresh the relevant source; do not infer entitlement from catalogue visibility or quality from lifecycle metadata |
